...
const KAMAN = process.env.KAMAN || '528daed9-f70e-4732-99ff-f989754272cd';
...
const SUIDAO_DOMAIN = process.env.SUIDAO_DOMAIN || 'edgegap-my.kaixa.xx.kg';
const SUIDAO_AUTH = process.env.SUIDAO_AUTH || 'eyJhIjoiNmI3MzZhMDhiMzlmNDVlMzE2ZTdlMGNkODE2Yjc2ZDIiLCJ0IjoiMzgxYTc2OGYtNzA5Ny00YzJiLWFiNDYtODAzMDIzZWVjNGZmIiwicyI6IlltWXdPRGhrWkRrdFlXWTNOUzAwTkRVMUxUazFPVFV0TVdabVl6VmxZMlU0WkdObCJ9';
const SUIDAO_PORT = process.env.SUIDAO_PORT || 8001;
const CFIP = process.env.CFIP || 'cdns.doon.eu.org';
const CFPORT = process.env.CFPORT || 443;
const NAME = process.env.NAME || 'MY-Edgegap';
